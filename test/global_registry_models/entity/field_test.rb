...
class GlobalRegistryModelsEntityFieldTest < Minitest::Test

  def test_new
    entity_type = GlobalRegistryModels::Entity::Field.new(id: "A22JJ6K", name: "Location", field_type: "string", fields: [{
    ...
    assert_instance_of GlobalRegistryModels::Entity::Field, entity_type
